...
BARCODE_TABLE = {
    ('8', '384'): PACKAGE_DIR / 'mapping/single_cell_info/V1_i7_i5_index.tsv',
    # TODO add 384 index table
    ('384', '384'): PACKAGE_DIR / 'mapping/single_cell_info/V2_i7_i5_index.tsv'
}
...
def make_sample_sheet(plate_info_paths, output_prefix, header_path=None):
    ...
    for plate_info_path in plate_info_paths:
        ...
        if (critical_info['n_random_index'], critical_info['input_plate_size']) == ('8', '384'):
            ...
            # TODO implement V2 prepare function
