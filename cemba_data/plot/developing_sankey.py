"""
This file is modified from pySankey,
See this LICENSE
https://github.com/anazalea/pySankey/blob/master/LICENSE
...
def sankey(left, right, ax, leftWeight=None, rightWeight=None, colorDict=None,
    ...
    for leftLabel in leftLabels:
        ...
        for rightLabel in rightLabels:
            leftDict[rightLabel] = dataFrame[
                (dataFrame.left == leftLabel) & (dataFrame.right == rightLabel)].leftWeight.sum()
            rightDict[rightLabel] = dataFrame[
                (dataFrame.left == leftLabel) & (dataFrame.right == rightLabel)].rightWeight.sum()
